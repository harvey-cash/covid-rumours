...
def clean_str(claim, filter_short=3, lemmatize=True, porter_stem=False, lan_stem=False, clean_non_alpha=True):
    word_tok = ToktokTokenizer()
    if clean_non_alpha:
    ...
    # NLTK stop words plus extra manuals
    stop_words = stopwords.words('english')
    stop_words.extend([
        "go", "come", "sometimes", "usually", "take", "mr", "run", "start",
        "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten",
        "first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth", "tenth",
        "also", "used", "st", "quite", "many", "back", "mainly", "opened", "use", "make", "side", "go",
        "get", "held", "name", "like", "got", "put", "told", "several"
    ])
